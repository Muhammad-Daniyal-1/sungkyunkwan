      ...
      <div className="md:col-span-4 relative">
        <div className="flex items-center gap-2">
          <div className="flex flex-col justify-between items-center mb-2 gap-3">
            <button className="p-2 rounded-full border border-[#E2EAE8]">
              <MdKeyboardArrowUp />
            </button>
            <p className="text-[#8188A1]">1</p>
            <p className="text-[#8188A1]">/</p>
            <p className="text-[#8188A1]">10</p>
            <button className="p-2 rounded-full border border-[#E2EAE8]">
              <MdKeyboardArrowDown />
            </button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div>
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-[#2D2F3E] text-lg">by. 홍길동</p>
                  <p className="text-[#8188A1] text-sm mt-2">2019/12/31</p>
                  <div className="flex items-center gap-2 mt-4">
                    <Image
                      ...
                      height={20}
                    />
                    <p className="text-[#11AC57] text-lg font-bold">1등</p>
                  </div>
                </div>
              </div>
              <p className="text-[#8188A1] mt-5">+ 홍길동님의 리뷰 더보기</p>
            </div>
